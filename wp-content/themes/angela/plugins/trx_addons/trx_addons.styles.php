...
if (!function_exists('angela_trx_addons_get_css')) {
	add_filter('angela_filter_get_css', 'angela_trx_addons_get_css', 10, 4);
	function angela_trx_addons_get_css($css, $colors, $fonts, $scheme='') {
