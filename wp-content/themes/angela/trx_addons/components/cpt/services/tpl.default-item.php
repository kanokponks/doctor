...
<div class="sc_services_item<?php
	...
	echo (isset($args['hide_excerpt']) && $args['hide_excerpt']==1) ? ' no-excerpt' : '';
...
?>>
	...
	<div class="sc_services_item_info">
		...
		<?php if (!isset($args['hide_excerpt']) || $args['hide_excerpt']==0) { ?>
			...
			<div class="sc_services_item_button sc_item_button"><a href="<?php echo esc_url($link); ?>" class="<?php echo esc_attr(apply_filters('trx_addons_filter_sc_item_link_classes', 'sc_button sc_button_iconed', 'sc_services', $args)); ?>"><span class="sc_button_icon"><span class="icon-double-right"></span></span></a></div>
		<?php } ?>
	</div>
</div>
<?php
